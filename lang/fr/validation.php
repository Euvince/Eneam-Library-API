...
return [
    ...
    'attributes'           => [
        ...
        'first_author_name'        => "Le nom du premier étudiant",
        'first_author_email'       => "L'email du premier étudiant",
        'second_author_name'       => "Le nom du deuxième étudiant",
        'second_author_email'      => "L'email du deuxième étudiant",
        'first_author_phone'       => "Le numéro de téléphone du premier étudiant",
        'second_author_phone'      => "Le numéro de téléphone du deuxième étudiant",
        'jury_president_name'      => "Le nom du président de jury",
        'memory_master_name'       => "Le nom du maître mémoire",
        'memory_master_email'      => "L'email du maître mémoire",
        'file_path'                => "Le mémoire soutenu",
        'cover_page_path'          => "La page de garde",
    ],
];
